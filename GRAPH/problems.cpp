...
void f_BPGD_L1T1(Graph& G, double th, int T, double r){
    ...
    Algo.initDecimation<L1T1>(v_bias,v_q, fixedSpins, fixedValues, notFixedSpins);
    
    Algo.BPGDiteration<L1T1>(th, flag_red, flag_approx, T, verbose, v_bias,v_q, fixedSpins, fixedValues, notFixedSpins);
...
void f_BPGD_L1T2(Graph& G, double th, int T, double r){
    ...
    Algo.initDecimation<L1T2>(v_bias,v_q, fixedSpins, fixedValues, notFixedSpins);
    
    Algo.BPGDiteration<L1T2>(th, flag_red, flag_approx, T, verbose, v_bias,v_q, fixedSpins, fixedValues, notFixedSpins);
