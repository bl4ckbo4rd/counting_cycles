...
inline vector <long double> Messages::def_computeMarginalsLastTime(L1T2, int l) {
    ...
    for (int xj = 0; xj < 2; ++xj){
        for(int xip = 0; xip < 2; ++xip){
            for(int xjp = 0; xjp < 2; ++xjp){
                for(int xipp = 0; xipp < 2; ++xipp){
                    for(int xjpp = 0; xjpp < 2; ++xjpp){
                        int t_ij = 32 * xipp + 16 * xjpp + 8 * xip + 4 * xjp + 2 * xi + xj;
                        sum1 += super_marginal[l][t_ij];
                    }
                }
            }
...
inline vector <long double> Messages::def_computeMarginalsLastTime(L1T3, int l) {
    ...
    for (int xj = 0; xj < 2; ++xj){
        for(int xip = 0; xip < 2; ++xip){
            for(int xjp = 0; xjp < 2; ++xjp){
                for(int xipp = 0; xipp < 2; ++xipp){
                    for(int xjpp = 0; xjpp < 2; ++xjpp){
                        for(int xippp = 0; xippp < 2; ++xippp){
                            for(int xjppp = 0; xjppp < 2; ++xjppp){
                                        int t_ij = 128 * xippp + 64 * xjppp + 32 * xipp + 16 * xjpp + 8 * xip + 4 * xjp + 2 * xi + xj;
                                        sum1 += super_marginal[l][t_ij];
                            }
                        }
                    }
...
template void Messages::Wrap_computeLastMarg<L1T2>();
template void Messages::Wrap_computeLastMarg<L1T3>();
