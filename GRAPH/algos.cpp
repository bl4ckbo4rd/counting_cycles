...
inline void BPGD::def_setHardBiasSite(L1T3, int n, int value) {
            ...
            for(int xj = 0; xj <=1; xj++){
                for(int xnp = 0; xnp <=1; xnp++){
                    for(int xjp = 0; xjp <=1; xjp++){
                        for(int xnpp = 0; xnpp <=1; xnpp++){
                            for(int xjpp = 0; xjpp <=1; xjpp++){
                                for(int xnppp = 0; xnppp <=1; xnppp++){
                                    for(int xjppp = 0; xjppp <=1; xjppp++){
                                        int t_nj = 128 * xnppp + 64 * xjppp + 32 * xnpp + 16 * xjpp + 8 * xnp + 4 * xjp + 2 * xn + xj;
                                        mess.bias[n][index_j][t_nj] = 0.;

                                        int t_jn = 128 * xnppp + 64 * xjppp + 32 * xnpp + 16 * xjpp + 8 * xnp + 4 * xjp + 2 * xj + xn;
                                        mess.bias[j][index_i][t_jn] = 0.;
                                    }
                                }
                            }
...
template void BPGD::setHardBias<L1T3>(vector<int>&, vector<bool>&);
...
template void BPGD::initDecimation<L1T3>(vector<int>&, vector<bool>&, vector<int>&, vector<bool>&, vector<int>&);
...
template void BPGD::BPGDiteration<L1T3>(double, int, int, int, bool, vector<int>&, vector<bool>&, vector<int>&, vector<bool>&, vector<int>&);
